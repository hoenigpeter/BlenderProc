...
for i in range(args.num_scenes):
    ...
    #new_targets: List[MeshObject] = []
    #new_distractors: List[MeshObject] = []
    #for tobj in sampled_target_bop_objs:
    #    if tobj in placed_objects:
    #        new_targets.append(tobj)
    #for dobj in sampled_distractor_bop_objs:
    #    if dobj in placed_objects:
    #        new_distractors.append(dobj)
    #sampled_target_bop_objs = new_targets
    #sampled_distractor_bop_objs = new_distractors
    ...
    while cam_poses < 25:
        ...
        #poi = bproc.object.compute_poi(np.random.choice(placed_target_bop_objs, size=10, replace=False))
