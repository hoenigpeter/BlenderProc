...
import numpy as np
import copy 
#python rerun.py run examples/datasets/bop_challenge/main_tless_random_3r_1o.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
