...
#python rerun.py run examples/datasets/bop_challenge/main_nocs.py /hdd/datasets_bop/shapenetcorev2/models_bop-renderer_scale=0.1 ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
params = {
    "cx": 321.6820068359375,
    "cy": 246.67500291765575,
    "depth_scale": 0.1,
    "fx": 617.52197265625,
    "fy": 617.853973400197,
    "height": 480,
...
number_of_objects_per_scene = 2
target_bop_objs = []

for obj_idx in range(number_of_objects_per_scene):
    target_bop_objs.append(bproc.loader.load_shapenet_random(args.shapenet_path, move_object_origin=True))
...
bproc.loader.load_bop_intrinsics_custom(params)
