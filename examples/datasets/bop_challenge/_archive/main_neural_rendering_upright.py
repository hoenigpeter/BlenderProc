...
for i in range(args.num_scenes):
    ...
    bproc.object.sample_poses(objects_to_sample = target_bop_objs,
    ...
    while cam_poses < 10:
        ...
        poi = bproc.object.compute_poi(np.random.choice(target_bop_objs, size=10, replace=False))
    ...
    bproc.writer.write_hdf5(os.path.join(args.output_dir, 'hdf5_data'), data, append_to_existing_output=True)