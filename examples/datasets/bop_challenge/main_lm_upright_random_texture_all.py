...
#python rerun.py run examples/datasets/bop_challenge/main_lm_upright_random_texture_all.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
