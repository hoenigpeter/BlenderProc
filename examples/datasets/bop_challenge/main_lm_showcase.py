...
#python rerun.py run examples/datasets/bop_challenge/main_lm_showcase.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
