...
#python rerun.py run examples/datasets/bop_challenge/main_tless_random_texture_reconstructed.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
target_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(args.bop_parent_path, 'tless'), mm2m = True)
...
for i in range(args.num_scenes):
    ...
    bproc.writer.write_bop(os.path.join(args.output_dir, 'bop_data'),
                           ...
                           dataset = 'tless_reconstructed_random_texture',
                           depth_scale = 0.1,
                           depths = data["depth"],
                           colors = data["colors"], 
