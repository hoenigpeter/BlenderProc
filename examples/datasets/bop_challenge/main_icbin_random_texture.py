...
#python rerun.py run examples/datasets/bop_challenge/main_icbin_random_texture.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
for j in range(10):
    for obj in target_bop_objs:
        new_objs.append(obj.duplicate())

for i in range(args.num_scenes):

    # Sample bop objects for a scene
    sampled_target_bop_objs = list(np.random.choice(new_objs, size=20, replace=False))
