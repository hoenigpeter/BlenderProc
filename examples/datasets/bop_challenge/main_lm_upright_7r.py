...
#python rerun.py run examples/datasets/bop_challenge/main_lm_upright_7r.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
for i in range(args.num_scenes):
    ...
    for idx, obj in enumerate(sampled_target_bop_objs):       
        ...
        cc_texture_from_list = cc_textures_list[idx][scene_cnt]
