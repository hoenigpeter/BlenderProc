...
import numpy as np
import copy 
#python rerun.py run examples/datasets/bop_challenge/main_tless_random_10r.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
cc_textures_list = []
for i in range(30):
    temp = bproc.loader.load_ccmaterials("examples/datasets/bop_challenge/cc_textures_10r/" + str(i))
    print("Folder: ", i)
