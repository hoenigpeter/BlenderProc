...
def render(output_directory, num):
    ...
    dataset = (
        ...
        .decode("pil")
        .to_tuple("__key__", "rgb.png", "segmentation.png", "camera_data.json", "object_datas.json", "infos.json")
    )
    ...
    for instance_id, _, _, camera_data, object_data, infos in tqdm(dataset, desc="Rendering"):
